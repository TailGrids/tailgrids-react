          ...
          <div className="container">
            <div className="flex flex-wrap -mx-4">
              <div className="w-full px-4">
                <h3 className="mb-10 text-[26px] font-semibold text-dark">
                  Order list
                </h3>
              </div>
              <div className="w-full px-4 lg:w-1/3">
                <div className="mb-12">
                  <ol>
                    <li className="flex mb-4 text-base text-body-color">
                      <span className="mr-2 flex h-6 w-full max-w-[24px] items-center justify-center rounded-full bg-primary text-base text-white">
                        1
                      </span>
              ...
              <div className="w-full px-4 lg:w-1/3">
                <div className="mb-12">
                  <ol>
                    <li className="flex mb-4 text-base text-body-color">
                      <span className="mr-2 flex h-6 w-full max-w-[24px] items-center justify-center rounded bg-primary text-base text-white">
                        1
                      </span>
                      Lorem ipsum dolor sit amet
                    </li>
                  ...
                  <ol>
                    <li className="flex mb-4 text-base text-body-color">
                      <span className="relative z-10 mr-2 flex h-6 w-full max-w-[24px] items-center justify-center rounded text-base text-white">
                        <span className="absolute top-0 left-0 z-[-1] h-full w-full -rotate-45 rounded bg-primary" />
                        1
                      </span>
                      Lorem ipsum dolor sit amet
                    </li>
              ...
              <div className="w-full px-4 lg:w-1/3">
                <div className="mb-12">
                  <ul>
                    <li className="flex mb-4 text-base text-body-color">
                      <span className="mr-2 text-base rounded-full text-primary">
                        <svg
                          width={20}
                          height={20}
                          viewBox="0 0 20 20"
              ...
              <div className="w-full px-4 lg:w-1/3">
                <div className="mb-12">
                  <ul>
                    <li className="flex mb-4 text-base text-body-color">
                      <span className="mr-2 text-base rounded-full text-secondary">
                        <svg
                          width={20}
                          height={20}
                          viewBox="0 0 20 20"
