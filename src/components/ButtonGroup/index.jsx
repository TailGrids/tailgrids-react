        ...
        <div className="inline-flex rounded-full">
          <a
            ...
            className={`inline-flex items-center justify-center ${
              (roundedLg && "rounded-l-lg") ||
              (roundedFull && "rounded-l-full") ||
              ...
              (info && `border-info bg-info hover:border-info hover:bg-info`) ||
              (dark && `border-dark bg-dark hover:border-dark hover:bg-dark`) ||
              (secondary &&
          ...
          <a
            href="/#"
            className={`inline-flex items-center justify-center border-y border-light py-[10px] px-[12px] text-center text-sm font-semibold text-black transition-all  ${
              (danger &&
                `border-danger  hover:border-danger hover:bg-danger`) ||
              (warning &&
                `border-warning  hover:border-warning hover:bg-warning`) ||
              (success &&
                `border-success  hover:border-success hover:bg-success`) ||
              (info && `border-info  hover:border-info hover:bg-info`) ||
              (dark && `border-dark  hover:border-dark hover:bg-dark`) ||
              (secondary &&
                `border-secondary  hover:border-secondary hover:bg-secondary`) ||
              (gray &&
                `border-body-color r hover:border-body-color hover:bg-body-color`)
            } hover:border-primary hover:bg-primary hover:text-white sm:py-3 sm:px-6 sm:text-base`}
          >
            <span className="pr-2">
              <svg
                width={15}
                ...
                className="fill-current"
              >
                <path d="M7.17188 4.40625H3.23438C3 4.40625 2.8125 4.59375 2.8125 4.82813C2.8125 5.0625 3 5.25 3.23438 5.25H7.17188C7.40625 5.25 7.59375 5.0625 7.59375 4.82813C7.59375 4.59375 7.38281 4.40625 7.17188 4.40625Z" />
                <path d="M3.23438 7.07813H5.03906C5.27344 7.07813 5.46094 6.89063 5.46094 6.65625C5.46094 6.42187 5.27344 6.23438 5.03906 6.23438H3.23438C3 6.23438 2.8125 6.42187 2.8125 6.65625C2.8125 6.89063 3 7.07813 3.23438 7.07813Z" />
                <path d="M6.25781 8.10938H3.21094C2.97656 8.10938 2.78906 8.29688 2.78906 8.53125C2.78906 8.76563 2.97656 8.95313 3.21094 8.95313H6.25781C6.49219 8.95313 6.67969 8.76563 6.67969 8.53125C6.67969 8.29688 6.49219 8.10938 6.25781 8.10938Z" />
                ...
                <path d="M11.2031 8.17969C10.8516 8.17969 10.5938 8.46094 10.5938 8.78906C10.5938 9.14062 10.875 9.39844 11.2031 9.39844C11.5547 9.39844 11.8125 9.11719 11.8125 8.78906C11.8359 8.46094 11.5547 8.17969 11.2031 8.17969Z" />
          ...
          <a
            href="/#"
            className={`inline-flex items-center justify-center ${
              (roundedLg && "rounded-r-lg") ||
              (roundedFull && "rounded-r-full") ||
              (roundedSm && "rounded-r-sm") ||
              (roundedNone && "rounded-none") ||
              (roundedMd && "rounded-r-md")
            } border ${
              (danger &&
                `border-danger  hover:border-danger hover:bg-danger`) ||
              (warning &&
              ...
              (gray &&
                `border-body-color r hover:border-body-color hover:bg-body-color`)
            }  border-light py-[10px] px-[12px] text-center text-sm font-semibold text-black transition-all hover:border-primary hover:bg-primary hover:text-white sm:py-3 sm:px-6 sm:text-base`}
          >
            <span className="pr-2">
              <svg
                width={15}
        ...
        <div className="inline-flex rounded-lg">
          <a
            ...
            className={`inline-flex items-center justify-center ${
              ...
              (gray &&
                `border-body-color bg-body-color hover:border-body-color hover:bg-body-color`)
            }  border-primary bg-primary py-[10px] px-[12px] text-center text-base font-semibold text-white transition-all hover:border-primary hover:bg-primary hover:text-white sm:py-3 sm:px-6`}
          >
            About
          </a>
          <a
            href="/#"
            className={`inline-flex items-center justify-center border-y border-light py-[10px] px-[12px] text-center text-sm font-semibold text-black transition-all hover:border-primary ${
              (danger &&
                `border-danger  hover:border-danger hover:bg-danger`) ||
              (warning &&
                `border-warning  hover:border-warning hover:bg-warning`) ||
              ...
              (gray &&
                `border-body-color r hover:border-body-color hover:bg-body-color`)
            } hover:bg-primary hover:text-white sm:py-3 sm:px-6 sm:text-base`}
          >
            Profile
          </a>
          <a
