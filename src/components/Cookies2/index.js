...
const index = ({ details, title, buttonText, titleRef }) => {
  ...
  return (
    <>
      {open && (
        <div className={`pt-6 pb-4 bg-black`}>
            ...
            <div className="flex flex-wrap items-center -mx-4">
              ...
              <div className="w-full px-4 lg:w-5/12">
                <div className="flex flex-wrap items-center lg:justify-end">
                  ...
                  >
                    <button class="inline-flex items-center justify-center rounded-md bg-white py-[10px] px-8 text-center text-base font-semibold text-body-color shadow-card hover:bg-opacity-90 hover:text-primary">
                      {buttonText}
                    </button>
