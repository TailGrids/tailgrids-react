              ...
              <ul className="flex flex-wrap justify-center mb-12 space-x-1">
                <li className="mb-1">
                  <button
                    ...
                    //   :className="showCards == 'all' ? activeClasses : inactiveClasses "
                ...
                <li className="mb-1">
                  <button
                    ...
                    //   :className="showCards == 'branding' ? activeClasses : inactiveClasses "
                    className={`inline-block rounded-lg py-2 px-5 text-center text-base font-semibold transition md:py-3 lg:px-8 ${
                      showCard === "branding"
                        ? "activeClasses"
                        : "inactiveClasses"
                ...
                <li className="mb-1">
                  <button
                    ...
                    //   :className="showCards == 'design' ? activeClasses : inactiveClasses "
                    className={`inline-block rounded-lg py-2 px-5 text-center text-base font-semibold transition md:py-3 lg:px-8 ${
                      showCard === "design"
                        ? "activeClasses"
                        : "inactiveClasses"
                ...
                <li className="mb-1">
                  <button
                    ...
                    //   :className="showCards == 'marketing' ? activeClasses : inactiveClasses "
                    className={`inline-block rounded-lg py-2 px-5 text-center text-base font-semibold transition md:py-3 lg:px-8 ${
                      showCard === "marketing"
                        ? "activeClasses"
                        : "inactiveClasses"
                ...
                <li className="mb-1">
                  <button
                    ...
                    //   :className="showCards == 'development' ? activeClasses : inactiveClasses "
                    className={`inline-block rounded-lg py-2 px-5 text-center text-base font-semibold transition md:py-3 lg:px-8 ${
