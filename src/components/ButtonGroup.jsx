          ...
          <div className="container">
            <div className="w-full mb-8">
              <div className="inline-flex">
                <a
                  href="/#"
                  className="inline-flex items-center justify-center border border-primary bg-primary py-[10px] px-[12px] text-center text-base font-semibold text-white transition-all hover:border-primary hover:bg-primary hover:text-white sm:py-3 sm:px-6"
                >
                  About
                </a>
                <a
                  href="/#"
                  className="inline-flex items-center justify-center border-y border-light py-[10px] px-[12px] text-center text-sm font-semibold text-black transition-all hover:border-primary hover:bg-primary hover:text-white sm:py-3 sm:px-6 sm:text-base"
                >
                  Profile
                </a>
                <a
                  href="/#"
                  className="inline-flex items-center justify-center border border-light py-[10px] px-[12px] text-center text-sm font-semibold text-black transition-all hover:border-primary hover:bg-primary hover:text-white sm:py-3 sm:px-6 sm:text-base"
                >
                  Services
                </a>
              </div>
            ...
            <div className="w-full mb-8">
              <div className="inline-flex rounded-lg">
                <a
                  href="/#"
                  className="inline-flex items-center justify-center rounded-l-lg border border-primary bg-primary py-[10px] px-[12px] text-center text-base font-semibold text-white transition-all hover:border-primary hover:bg-primary hover:text-white sm:py-3 sm:px-6"
                >
                  About
                </a>
                <a
                ...
                <a
                  href="/#"
                  className="inline-flex items-center justify-center rounded-r-lg border border-light py-[10px] px-[12px] text-center text-sm font-semibold text-black transition-all hover:border-primary hover:bg-primary hover:text-white sm:py-3 sm:px-6 sm:text-base"
                >
                  Services
                </a>
              </div>
            ...
            <div className="w-full mb-8">
              <div className="inline-flex rounded-full">
                <a
                  href="/#"
                  className="inline-flex items-center justify-center rounded-l-full border border-primary bg-primary py-[10px] px-[12px] text-center text-base font-semibold text-white transition-all hover:border-primary hover:bg-primary hover:text-white sm:py-3 sm:px-6"
                >
                  About
                </a>
                <a
                ...
                <a
                  href="/#"
                  className="inline-flex items-center justify-center rounded-r-full border border-light py-[10px] px-[12px] text-center text-sm font-semibold text-black transition-all hover:border-primary hover:bg-primary hover:text-white sm:py-3 sm:px-6 sm:text-base"
                >
                  Services
                </a>
              </div>
