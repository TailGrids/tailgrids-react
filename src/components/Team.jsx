            ...
            <div className="flex flex-wrap justify-center -mx-4">
              <div className="w-full px-4 md:w-1/2 xl:w-1/4">
                <div className="mx-auto mb-10 w-full max-w-[370px]">
                  <div className="relative overflow-hidden rounded-lg">
                    <img
                      src="https://i.ibb.co/T1J9LD4/image-03-2.jpg"
                      alt=""
                      className="w-full"
                    />
              ...
              <div className="w-full px-4 md:w-1/2 xl:w-1/4">
                <div className="mx-auto mb-10 w-full max-w-[370px]">
                  <div className="relative overflow-hidden rounded-lg">
                    <img
                      src="https://i.ibb.co/yVVT0Dp/image-02-2.jpg"
                      alt=""
                      className="w-full"
                    />
                    <div className="absolute left-0 w-full text-center bottom-5">
              ...
              <div className="w-full px-4 md:w-1/2 xl:w-1/4">
                <div className="mx-auto mb-10 w-full max-w-[370px]">
                  <div className="relative overflow-hidden rounded-lg">
                    <img
                      src="https://i.ibb.co/30tGtjP/image-04.jpg"
                      alt=""
                      className="w-full"
                    />
                    <div className="absolute left-0 w-full text-center bottom-5">
              ...
              <div className="w-full px-4 md:w-1/2 xl:w-1/4">
                <div className="mx-auto mb-10 w-full max-w-[370px]">
                  <div className="relative overflow-hidden rounded-lg">
                    <img
                      src="https://i.ibb.co/8P6cvVy/image-01-1.jpg"
                      alt=""
                      className="w-full"
                    />
                    <div className="absolute left-0 w-full text-center bottom-5">
