          ...
          >
            <span
              className={` ${
                ...
                (position === "left" &&
                  `absolute -right-1 top-1/2 -z-10 h-2 w-2 -translate-y-1/2 rotate-45 rounded-xs border-r border-t border-light bg-white`) ||
                (position === "bottom" &&
                  `absolute -top-1 left-1/2 -z-10 h-2 w-2 -translate-x-1/2 rotate-45 rounded-xs border-l border-t border-light bg-white`)
              } `}
            ></span>
            {tooltipsText}
          </div>
