        ...
        <div className="mx-auto w-full max-w-[500px]">
          <div className="relative">
            <textarea
              ...
              className="w-full rounded-lg border border-stroke bg-gray-1 p-5 leading-relaxed text-body-color outline-none duration-200 selection:bg-transparent focus:border-primary dark:border-dark-3 dark:bg-dark-2 dark:text-dark-6"
            />
            <button
              onClick={copyToClipboard}
              className="absolute right-5 top-5 inline-flex h-8 items-center justify-center gap-1 rounded-md border border-stroke bg-white px-2.5 py-1.5 text-sm font-medium text-dark duration-200 hover:bg-dark hover:text-white dark:border-dark-3"
            >
              <span>
                {copySuccess ? (
                  <svg
