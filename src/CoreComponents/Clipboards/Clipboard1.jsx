      ...
      <div className="container">
        <div className="mx-auto flex w-full max-w-[450px] gap-3">
          <input
            ...
            className="h-12 w-full rounded-lg border border-stroke bg-transparent px-5 py-3 text-dark outline-none duration-200 selection:bg-transparent focus:border-primary dark:border-dark-3 dark:text-white"
          />
          <button
            onClick={copyToClipboard}
            className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-primary px-6 py-3 text-base font-medium text-white duration-200 hover:bg-primary/90"
          >
            <span>
              {copySuccess ? (
                <svg
