      ...
      <div className="container">
        <div className="mx-auto flex w-full max-w-[450px] gap-3">
          <input
            ...
            className="h-12 w-full rounded-lg border border-stroke bg-transparent px-5 py-3 text-dark outline-none duration-200 focus:border-primary dark:border-dark-3 dark:text-white"
          />
