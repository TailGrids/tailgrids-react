        ...
        <div className="w-full max-w-[500px]">
          <div>
            ...
            <div className="relative">
              <select
                name="choose-country"
                className="w-full appearance-none rounded-lg border border-stroke bg-transparent px-12 py-3 text-dark outline-none focus:border-primary dark:border-dark-3 dark:text-white"
              >
