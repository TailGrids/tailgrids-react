        ...
        <div>
          ...
          <div className="flex items-center justify-between py-5">
            <div>
              <span
                style={{ left: minThumb + "%" }}
                className="absolute -top-16 ml-1 -translate-x-1/2 rounded bg-white px-3 py-2 text-center text-dark shadow-lg after:absolute after:-bottom-1.5 after:left-1/2 after:h-3 after:w-3 after:-translate-x-1/2 after:rotate-45 after:rounded-br-sm after:bg-inherit dark:bg-dark-3 dark:text-white"
              >
                {minValue}
              </span>
            </div>
            <div>
              <span
                style={{ right: maxThumb + "%" }}
                className="absolute -top-16 mr-1 translate-x-1/2 rounded bg-white px-3 py-2 text-center text-dark shadow-lg after:absolute after:-bottom-1.5 after:left-1/2 after:h-3 after:w-3 after:-translate-x-1/2 after:rotate-45 after:rounded-br-sm after:bg-inherit dark:bg-dark-3 dark:text-white"
              >
                {maxValue}
              </span>
            </div>
